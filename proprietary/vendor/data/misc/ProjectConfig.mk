...
# Chenyee <20180508> <taofp> add for cy_build cy_auto_config_begin
CY_FULL_TARGET_PRODUCT=full_k71v1_64_bsp
CY_AUTO_ADD_GLOBAL_DEFINE_BY_NAME=CY_A_BEGIN CY_BSP_CLOSE_MTK_BOARD_SIGN_IMG CY_A_END
CY_AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE=CY_B_BEGIN CONFIG_CY_BSP_MTK_GAMMA_FUNCTION_SUPPORT CY_NEW_LCD_EFFECT_SUPPORT GN_CAMERA_FEATURE_SUPPORT GN_GIONEE_FEATURE_SUPPORT GN_GIONEE_SCENE_DETECTION_SUPPORT GN_GIONEE_WATER_MARK_EFFECT_SUPPORT GN_GIONEE_LIVE_EFFECT_SUPPORT GN_MORPHO_FEATURE_SUPPORT GN_MORPHO_FACE_BOKEH_SUPPORT GN_MORPHO_HDR_SUPPORT GN_MORPHO_LOWLIGHT_SUPPORT GN_MORPHO_PANORAMA_SELFIE_SUPPORT GN_OMRON_FEATURE_SUPPORT GN_OMRON_FACE_BEAUTY_SUPPORT CY_MARS_FEATURE_SUPPORT CY_MARS_FACEID_SUPPORT GN_CAMERA_MANUAL_SHUTTER GN_DUAL_CAMERA_FEATURE_SUPPORT GN_DUAL_CAMERA_FEATURE_AT_SUPPORT CY_B_END
CY_AUTO_ADD_GLOBAL_DEFINE_BY_VALUE=CY_C_BEGIN CY_C_END
CY_KERNEL_CFG_FILE_ENG=kernel-4.4/arch/arm64/configs/k71v1_64_bsp_debug_defconfig
CY_KERNEL_CFG_FILE=kernel-4.4/arch/arm64/configs/k71v1_64_bsp_defconfig
CONFIG_BUILD_ARM64_DTB_OVERLAY_IMAGE_NAMES=mediatek/k71v1_64_bsp
CONFIG_CY_BSP_USE_SINGLE_DTB=yes
CONFIG_MTK_USB_UNIQUE_SERIAL=yes
CONFIG_CY_BSP_RECOVERY_NO_SELECT=yes
CY_MTK_BSP_META_CONNECT=yes
CONFIG_CY_BSP_MTK_DEBUG_USER_VERSION_SUPPORT=yes
CONFIG_TWOKEY_REBOOT_NORMAL_MODE=n
CONFIG_TWOKEY_REBOOT_OTHER_MODE=n
...
CONFIG_MTK_GROUP_ENABLE_VERITY=y
CONFIG_SYSTEM_AS_ROOT=y
SYSTEM_AS_ROOT=yes
CONFIG_ANDROID_BINDER_IPC_32BIT=n
CONFIG_CY_BSP_CPU_MAXFREQ_CUSTOM_SUPPORT=yes
BOOT_LOGO=fhdplus
LCM_HEIGHT=2246
LCM_WIDTH=1080
MTK_LCM_DEVICE_TREE_SUPPORT=no
CONFIG_MTK_LCM_DEVICE_TREE_SUPPORT=no
CONFIG_LCM_HEIGHT=2246
CONFIG_LCM_WIDTH=1080
CONFIG_CUSTOM_KERNEL_LCM=cy_tm_nt36672a cy_tcl_hx83112
CUSTOM_LK_LCM=cy_tm_nt36672a cy_tcl_hx83112
MTK_LCM_PHYSICAL_ROTATION_HW=no
CONFIG_MTK_LCM_PHYSICAL_ROTATION_HW=n
CONFIG_MTK_AAL_SUPPORT=y
MTK_AAL_SUPPORT=yes
CONFIG_CY_BSP_MTK_GAMMA_FUNCTION_SUPPORT=yes
CY_NEW_LCD_EFFECT_SUPPORT=yes
CONFIG_CY_BSP_MT6370_SOFT_RESET=yes
CONFIG_CY_BSP_MTK_DEVICE_CHECK=yes
CONFIG_TOUCHSCREEN_MTK_FOCALTECH_TS=n
CONFIG_CY_BSP_CTP_NT36772A_SUPPORT=y
CONFIG_CY_BSP_MTK_HALL_KEY=y
CONFIG_CY_BSP_CTP_NV36772A_HALL_SUPPORT=yes
CONFIG_CY_BSP_CTP_HX83112_SUPPORT=y
CONFIG_CY_BSP_CTP_COMPATIBLE_SUPPORT=yes
CONFIG_MTK_MC3410_I2C=no
CONFIG_MTK_ITG1010=no
CONFIG_MTK_CM36558=no
CONFIG_MTK_AKM09918=no
...
CONFIG_CY_BSP_ACCEL_HUB=icm20600
CONFIG_CY_BSP_GYRO_HUB=icm20600
CONFIG_CY_BSP_ALSPS_HUB=stk3x1x
CONFIG_CY_BSP_MAG_HUB=akm09918
CUSTOM_KERNEL_DEVICE_ORIENTATION=no
CONFIG_MTK_DEVICE_ORIENTATION_HUB=no
CONFIG_CY_BSP_PS_STATIC_CALIBRATION=yes
CY_BSP_META_EXTEND_SUPPORT=yes
MTK_CUSTOM_USERLOAD_ENGINEERMODE=yes
CONFIG_CY_BSP_LUX_LINEAR_REPORT=yes
CONFIG_CY_BSP_CUSTOM_KERNEL_PICK_UP_SENSOR=no
CUSTOM_KERNEL_PICK_UP_SENSOR=yes
CONFIG_MTK_PICKUPHUB=yes
CUSTOM_KERNEL_SIGNIFICANT_MOTION_SENSOR=no
CUSTOM_KERNEL_UNCALI_ACC_SENSOR=no
CONFIG_CUSTOM_KERNEL_UNCALI_ACC_SENSOR=no
CUSTOM_KERNEL_UNCALI_GYRO_SENSOR=no
CONFIG_CUSTOM_KERNEL_UNCALI_GYRO_SENSOR=no
CUSTOM_KERNEL_UNCALI_MAG_SENSOR=no
CONFIG_CUSTOM_KERNEL_UNCALI_MAG_SENSOR=no
CONFIG_MTK_DUAL_CHARGER_SUPPORT=no
CONFIG_MTK_PUMP_EXPRESS_PLUS_SUPPORT=no
CONFIG_MTK_PUMP_EXPRESS_PLUS_20_SUPPORT=no
CONFIG_USB_C_SWITCH_U3_MUX=no
CONFIG_USB_POWER_DELIVERY=no
CONFIG_CHARGER_RT9465=no
CONFIG_WIRELESS_RX_RT1653=yes
CONFIG_MTK_WIRELESS_CHARGER_SUPPORT=yes
CONFIG_CY_BSP_MMITEST_CHGCUR=yes
MTK_PUMP_EXPRESS_SUPPORT=no
MTK_PUMP_EXPRESS_PLUS_SUPPORT=no
CONFIG_CY_BSP_MTK_DEVICE_CHECK=yes
CONFIG_CY_BSP_MULTI_BAT_SUPPORT=yes
CY_BSP_CHARGING_ANIMATION_SUPPORT=yes
CY_BSP_CHARGING_ANIMATION_WIRELESS_SUPPORT=yes
CONFIG_CY_BSP_CHARGING_CALL_LIMIT_VALUE=1000000
CONFIG_CY_BSP_THERMAL_CHARGER_INPUT_LIMIT_SUPPORT=yes
CONFIG_CY_BSP_MTK_PERFMGR_TOUCH_BOOST=y
CONFIG_CY_BSP_MTK_PERFMGR_TARTGET_FOR_MT6771=y
CONFIG_CY_BSP_IDLE_LOW_FPS_SUPPORT=y
CONFIG_CY_BSP_MTK_MT6771T_GPU_TURBO=y
CONFIG_CY_BSP_CPU_MAXFREQ_CUSTOM_SUPPORT=y
CY_BSP_AUDIO_SUPPORT=yes
CONFIG_CY_BSP_AUDIO_SUPPORT=yes
CONFIG_CY_BSP_AUDIO_TYPEC_ACCDET_SUPPORT=yes
MTK_AUDIO_SPH_LPBK_PARAM=yes
CY_AUDIO_MIC_MODE_ACC=yes
CONFIG_ACCDET_EINT_IRQ=no
CONFIG_ACCDET_EINT=yes
...
MTK_GOOGLE_TRUSTY_SUPPORT=no
CONFIG_TRUSTY=n
CONFIG_MT_TRUSTY_DEBUGFS=n
CONFIG_MOBICORE_API=yes
CONFIG_MOBICORE_DRIVER=yes
CONFIG_TRUSTONIC_TEE_SUPPORT=y
CONFIG_MTK_TEE_GP_SUPPORT=y
CY_BSP_FACEDATA_TEE_API_SUPPORT=yes
MTK_PERSIST_PARTITION_SUPPORT=yes
CY_BSP_TEE_SIGN_SUPPORT=yes
CONFIG_MTK_FINGERPRINT_SUPPORT=yes
CONFIG_CY_BSP_FINGERPRINT_SUNW6161=yes
CY_BSP_FINGER_IMAGE_DUMP_SUPPORT=yes
MTK_CAM_DLFD_SUPPORT=no
CONFIG_CUSTOM_KERNEL_IMGSENSOR=ov16885rear_mipi_raw ov16885_mipi_raw hi556_mipi_raw ov7251_mipi_raw
CUSTOM_HAL_IMGSENSOR=ov16885rear_mipi_raw ov16885_mipi_raw hi556_mipi_raw ov7251_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR=hi556_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR=ov16885rear_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR=ov16885_mipi_raw ov7251_mipi_raw
CUSTOM_KERNEL_IMGSENSOR=ov16885rear_mipi_raw ov16885_mipi_raw hi556_mipi_raw ov7251_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR=hi556_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR=ov16885rear_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR=ov16885_mipi_raw
MTK_CAM_MAX_NUMBER_OF_CAMERA=4
CONFIG_MTK_CAM_MAX_NUMBER_OF_CAMERA=4
CONFIG_MTK_LENS_DW9714VAF_SUPPORT=yes
CUSTOM_HAL_LENS=dummy_lens dw9714vaf
CUSTOM_HAL_MAIN_LENS=dw9714vaf
CUSTOM_HAL_SUB_LENS=dummy_lens
CUSTOM_KERNEL_LENS=dummy_lens dw9714vaf
CUSTOM_KERNEL_MAIN_LENS=dw9714vaf
CUSTOM_KERNEL_SUB_LENS=dummy_lens
CONFIG_MTK_FLASHLIGHT_MT6370=yes
CONFIG_CY_BSP_FLASHLIGHT_SGM3758=yes
CONFIG_CY_BSP_KERNEL_FLASHLIGHT=yes
CONFIG_CY_BSP_KERNEL_FLASHLIGHT_TEST=yes
CONFIG_MTK_FLASHLIGHT_PT_STRICT=n
MTK_CAM_STEREO_CAMERA_SUPPORT=yes
MTK_CAM_VSDOF_SUPPORT=yes
CONFIG_CY_BSP_KERNEL_POWER_CUSTOM_REGULATOR=yes
MTK_CAM_DLFD_SUPPORT=no
MTK_CAM_PORTRAIT_SUPPORT=no
CUSTOM_MODEM=CSW1703_71_B_MODEM
CY_MODEM_CONFIG=CSW1703_B.mk
...
MTK_MD3_SUPPORT=0
MTK_SIM_HOT_SWAP=y
MTK_SIM_HOT_SWAP_COMMON_SLOT=y
CONFIG_MTK_MD1_SUPPORT=14
CONFIG_MTK_C2K_LTE_MODE=0
CONFIG_MTK_MD3_SUPPORT=0
CONFIG_MTK_ECCCI_C2K=y
CY_RO_CY_MMI_GSM=yes
CY_RO_CY_MMI_WCDMA=yes
CY_RO_CY_MMI_CDMA=no
CY_RO_CY_MMI_TDSCDMA=no
CY_RO_CY_MMI_LTETDD=no
CY_RO_CY_MMI_LTEFDD=yes
CY_RO_CY_MMI_WEFUSE=yes
CY_BSP_CLOSE_MTK_BOARD_SIGN_IMG=yes
...
CY_RO_PRODUCT_BRAND=soda
CY_RO_PRODUCT_NAME=CSW1703
CY_RO_PRODUCT_MODEL=CSW1703
CY_RO_BUILD_DISPLAY_ID=CSW1703
CY_RO_CY_EXT_MODEL=CSW1703
CY_RO_PRODUCT_BOARD=CSW1703
CY_RO_PRODUCT_DEVICE=CSW1703
CY_RO_PRODUCT_MANUFACTURER=soda
CY_EXTERNAL_VER_NUMBER=ROM9.0.0
CY_RO_CY_ROM_VERNUMBER=ROM9.0.0
CY_RO_HW_VERSION=Mainboard_P3
CY_RO_PRODUCT_SCREENSIZE=6.2
CY_ROM_VERSION=Passion UI 1.1
CY_RO_CY_HARDWAREVER=P2
MTK_PERMISSION_CONTROL=no
MTK_MOBILE_MANAGEMENT=no
MTK_CTA_SET=no
MTK_DATA_TRANSFER_APP=no
MTK_PRODUCT_LOCALES=en_US in_ID zh_CN zh_TW es_ES pt_BR ru_RU fr_FR de_DE tr_TR vi_VN ms_MY th_TH it_IT ar_EG hi_IN bn_IN ur_PK fa_IR pt_PT nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ ko_KR km_KH iw_IL my_MM pl_PL es_US bg_BG hr_HR lv_LV lt_LT sk_SK uk_UA de_AT da_DK fi_FI nb_NO sv_SE en_GB hy_AM zh_HK et_EE ja_JP kk_KZ sr_RS sl_SI ca_ES
MTK_FILEMANAGER_APP=no
MTK_LOG_CUSTOMER_SUPPORT=yes
MTK_RUNNING_BOOSTER_SUPPORT=no
MTK_FACTORY_MODE_IN_GB2312=no
MTK_FULLSCREEN_SWITCH_SUPPORT=yes
CY_APK_CY_FACTORYTESTS_SUPPORT=yes
CY_APK_AutoMMI_SUPPORT=yes
CY_APK_CY_MMI_SUPPORT=yes
CY_RO_CY_MMI_GSM=yes
CY_RO_CY_MMI_WCDMA=yes
CY_RO_CY_MMI_CDMA=yes
CY_RO_CY_MMI_TDSCDMA=no
CY_RO_CY_MMI_LTETDD=yes
CY_RO_CY_MMI_LTEFDD=yes
CY_RO_CONFIG_NOTIFICATION_SOUND=DontPanic.ogg
CY_RO_CONFIG_ALARM_ALERT=Carbon.ogg
CY_RO_CONFIG_RINGTONE=Atria.ogg
CY_RO_CY_DEFAULT_RINGTONE2=Atria.ogg
CY_RO_CY_DEFAULT_MMSTONE=DontPanic.ogg
CY_RO_CY_DEFAULT_MMSTONE2=DontPanic.ogg
CY_APP_SETTINGSPROVIDER_SUPPORT=yes
CY_APK_SETTINGS_SUPPORT=yes
CY_SCHEDULE_POWER_ONOFF_SUPPORT=yes
CY_APK_CY_FLOATINGTOUCH_SUPPORT=yes_refactoring
CY_QUICK_UNLOCK_SUPPORT=yes
CY_AOSP_BROWSER_SUPPORT=no
CY_MTK_BROWSER_SUPPORT=no
CY_MTK_WEBVIEW_SUPPORT=no
CY_MTK_LATINIME_SUPPORT=no
CY_MTK_CELLBROADCASTRECEIVER_SUPPORT=no
CY_MTK_QUICKSEARCHBOX_SUPPORT=no
CY_AOSP_CELLBROADCASTRECEIVER_SUPPORT=no
CY_AOSP_QUICKSEARCHBOX_SUPPORT=no
CY_AOSP_EXACTCALCULATOR_SUPPORT=no
CY_AOSP_NFC_SUPPORT=no
CY_AOSP_DIALER_SUPPORT=no
CY_AOSP_CONTACTS_SUPPORT=no
CY_SHOW_DUL_IMEI_MEID=yes
CY_PRIVATESPACE_ONE=yes
CY_APP_CONTACTS_SUPPORT=yes
CY_OVERTURN_MUTE_SUPPORT=yes
CY_VOLUME_UP_ANSWER_SUPPORT=yes
CY_IN_CALL_VIBRATION_SUPPORT=yes
CY_INCOMING_VOLUME_UP_SUPPORT=yes
CY_APPCLONE_SUPPORT=yes
CY_APK_APPCLONE_SUPPORT=yes
CY_HANDSETHOOK_SUPPORT=yes
CY_FM_AIRPLANEMODE=yes
CY_LCD_EFFECT_SUPPORT=no
CY_NEW_LCD_EFFECT_SUPPORT=yes
CY_DISTANCEGESTURE_SUPPORT=no
TORCH_GESTURE_SUPPORT=yes
CY_PERFECT_SUSPENDBUTTON=yes
CY_FINGER_PRIVATE=yes
CY_PRIVATESPACE_ONE=yes
CY_BACK_FINGER_SUPPORT=yes
CY_SSGACCESSCALL_SUPPORT=no
CY_SSGDIAL_SUPPORT=no
CY_RAISE_WAKE_SUPPORT=yes
CY_SMARTSTAY_SUPPORT=yes
CY_RO_QUICKOPERATE_SUPPORT=yes
RO_CY_RESPIRATIONLAMP_SUPPORT=no
CY_PASSWORD_PROTECTION=yes
CY_APP_OVERSEA_THEME=Fresh_fullscreen AndroidO_notch
CY_THEME_DEFAULT_PACKAGENAME=/system/app/Fresh_fullscreen.gnz
CY_APP_FILEMANAGER_SUPPORT=yes
CY_APP_SOUNDRECORDER_SUPPORT=yes
CY_APP_SYSTEMMANAGER_SUPPORT=yes
CY_APP_SYSTEMMANAGER_SDK_SUPPORT=yes
CY_APP_POWERSAVELAUNCHER_SUPPORT=yes
CY_APP_NEW_POWERSAVELAUNCHER_SUPPORT=yes
CY_COMMON_MAINBOARD=CSW1703
CY_APP_RINGTONE_SUPPORT=yes
CY_APP_NOTE_SUPPORT=yes
CY_APP_COMPASS_SUPPORT=yes
CY_APP_FLASHLIGHT_SUPPORT=yes
CY_APP_SYNCHRONIZER_SUPPORT=yes
CY_APP_MUSIC_SUPPORT=yes
CY_APP_CALENDAR_SUPPORT=yes
CY_APP_DATACLONE_SUPPORT=yes
CY_APK_CYEE_CAREFREELAUNCHER_SUPPORT=yes
CY_APP_CHANGER_SUPPORT=yes
CY_APP_SCREENRECORDER_SUPPORT=yes
CY_APP_LONGSCREENSHOT_SUPPORT=yes
CY_APP_SEARCH_SUPPORT=yes
CY_APP_GALLERY2_SUPPORT=yes
CY_APP_VIDEO_SUPPORT=yes
CY_APP_OTA_SUPPORT=yes
CY_OTA_SERVER=ota.chenyee.com:90
CY_APP_DESKCLOCK_SUPPORT=yes
CY_APP_CAMERA_SUPPORT=yes_4_5_4
CY_APP_LAUNCHER_SUPPORT=yes
CY_APP_SYSTEMUI_SUPPORT=yes
CY_APP_STORYLOCKER_SUPPORT=yes
CY_APP_DYNAMICWEATHER_SUPPORT=yes
CY_APP_MMS_SUPPORT=yes
CY_APK_APPLOCK_SUPPORT=yes
CY_APP_SCREENLOCK_ALBUM_SUPPORT=yes
CY_APP_COMPASS_SUPPORT=yes
CY_APP_CALCULATOR_SUPPORT=yes
CY_APP_FLASHLIGHT_SUPPORT=yes
CY_APP_SYNCHRONIZER_SUPPORT=yes
CY_APP_LABORATORY_SUPPORT=yes
CY_EYEPROTECT_SUPPORT=yes
CHENYEE_DATA_MANAGER_SUPPORT=yes
CY_APP_BUGREPORT_SUPPORT=dev
CY_VIDEO_YOUTUBE_SUPPORT=yes
CY_FACTORY_AUTO_SHUTDOWN_SUPPORT=yes
GN_CAMERA_FEATURE_SUPPORT=yes
GN_GIONEE_FEATURE_SUPPORT=yes
GN_GIONEE_SCENE_DETECTION_SUPPORT=yes
GN_GIONEE_WATER_MARK_EFFECT_SUPPORT=yes
GN_GIONEE_LIVE_EFFECT_SUPPORT=yes
GN_MORPHO_FEATURE_SUPPORT=yes
GN_MORPHO_FACE_BOKEH_SUPPORT=yes
GN_MORPHO_HDR_SUPPORT=yes
GN_MORPHO_LOWLIGHT_SUPPORT=yes
GN_MORPHO_PANORAMA_SELFIE_SUPPORT=no
GN_OMRON_FEATURE_SUPPORT=yes
GN_OMRON_FACE_BEAUTY_SUPPORT=yes
GN_CAMERA_MANUAL_SHUTTER=yes
CY_MARS_FEATURE_SUPPORT=yes
CY_MARS_FACEID_SUPPORT=yes
CYEE_DEVICE=yes
CY_CAMERA_ZSL_DEFAULT_ON=yes
CY_SWITCH_STORAGE_SUPPORT=yes
CY_CAMERA_STEREO_SUPPORT=mtks2s_facebokeh
GN_DUAL_CAMERA_FEATURE_SUPPORT=yes
GN_DUAL_CAMERA_FEATURE_AT_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_SUPPORT=yes_4_5_4
CY_APP_CAMERA_PLUGIN_HDR_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_NIGHT_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_FACEBEAUTY_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_PROSETTING_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_PANORAMA_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_SELFIEPANORAMA_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_SLOWMOTION_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_TIMELAPSE_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_ANIMOJI_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_LIVEPHOTO_SUPPORT=yes
CY_CAMERA_DEBUG_INFO_OFF=yes
MTK_SOUNDRECORDER_APP=no
MTK_FULLSCREEN_SWITCH_SUPPORT=yes
CY_FACE_LOCK_SUPPORT=yes
CY_FACE_LOCK_LIGHT_SUPPORT=yes
CY_ENABLE_PERMISSION=yes
MTK_YIQI_FONTS_FRAMEWORK_SUPPORT=yes
LOVELYFONTS_SUPPORT=yes
MTK_PRIVACY_PROTECTION_LOCK=no
CY3RD_GMS_SUPPORT=9_201909
CY3RD_GMS_APPLICATION=GoogleTTS GmsCore PlayStore SetupWizard WebViewGoogle Chrome Drive Gmail2 Duo Maps Music2 Photos GoogleSearch Videos YouTube LatinImeGoogle Talkback CalendarGoogle GoogleDialer GoogleContacts Messages DeskClockGoogle CalculatorGoogle CarrierServices FilesGo
CY_NOT_ODEX_OPTIMIZE=Chrome Drive Gmail2 Maps Music2 Photos Videos YouTube Duo Messages
FIRST_API_LEVEL_FOR_O1=yes
CY_CAMERA_NOTCH_BLU_SUPPORT=yes
GMS_ACSA_SUPPORT=yes
CY_ENABLE_PERMISSION=yes
MTK_CMAS_SUPPORT=yes
MTK_BG_POWER_SAVING_SUPPORT=no
MTK_BG_POWER_SAVING_UI_SUPPORT=no
CY_BSP_EFUSE_VERIFIED_BOOT_MP_PUB_KEY=yes
CY_BSP_EFUSE_VERIFIED_BOOT_RD_KEY=no
CY_BSP_EFUSE_VERIFIED_BOOT_MTK_KEY=no
CONFIG_CY_BSP_EFUSE_SBC_FLAG=yes
CONFIG_CY_BSP_EFUSE_BLOWER=yes
...
CY_BSP_OTA_SECUREBOOT=yes
CONFIG_CY_BSP_MT6771_PLATFORM=yes
CY_RO_PRODUCT_BRAND=BLU
CY_RO_PRODUCT_NAME=Vivo_XI
CY_RO_PRODUCT_MODEL=Vivo XI+
CY_RO_BUILD_DISPLAY_ID=BLU_V0310WW_V9.0.04.09_GENERIC
CY_RO_CY_EXT_MODEL=Vivo XI+
CY_RO_PRODUCT_BOARD=CSW1703
CY_RO_PRODUCT_DEVICE=V0310WW
CY_RO_PRODUCT_MANUFACTURER=BLU
CY_BLU_PARTNUMBER=V0310WW
CY_EXTERNAL_VER_NUMBER=ROM9.0.0
CY_RO_CY_ROM_VERNUMBER=ROM9.0.0
CY_RO_HW_VERSION=Mainboard_P3
CY_RO_PRODUCT_SCREENSIZE=6.2
CY_ROM_VERSION=Passion UI 1.1
CY_RO_CY_HARDWAREVER=P2
CY_APP_CONTACTS_SUPPORT=no
CY_OVERTURN_MUTE_SUPPORT=no
CY_VOLUME_UP_ANSWER_SUPPORT=no
CY_IN_CALL_VIBRATION_SUPPORT=no
CY_INCOMING_VOLUME_UP_SUPPORT=no
CY_APP_OVERSEA_THEME=Fresh_fullscreen AndroidO_notch
CY_THEME_DEFAULT_PACKAGENAME=/system/app/AndroidO_notch.gnz
CY_APP_FILEMANAGER_SUPPORT=no
CY_APP_CALCULATOR_SUPPORT=no
CY_APP_CALENDAR_SUPPORT=no
CY_APP_CHANGER_SUPPORT=yes_NoIcon
CY_APP_GALLERY2_SUPPORT=no
CY_APP_OTA_SUPPORT=no
CY_APP_DESKCLOCK_SUPPORT=no
CY_APP_DYNAMICWEATHER_SUPPORT=no
CY_APP_MMS_SUPPORT=no
CY_APK_APPLOCK_SUPPORT=no
CY_FULLSCREEN_DEFAULT_ON=yes
CY_FACTORY_AUTO_SHUTDOWN_SUPPORT=yes
CY_NEW_LCD_EFFECT_SUPPORT=yes
MTK_PRODUCT_LOCALES=
CY_ODM=yes
CY_CUSTOM=SOUTH_AMERICA_BLU
CY_SOUTH_AMERICA_BLU=yes
CY_RW_PERSIST_SYS_TIMEZONE=America/New_York
CY_RO_CONFIG_NOTIFICATION_SOUND=BLU_Message3.mp3
CY_RO_CONFIG_ALARM_ALERT=AlarmClock2.mp3
CY_RO_CONFIG_RINGTONE=BLU_Ringtone4.mp3
CY_RO_CY_DEFAULT_RINGTONE2=BLU_Ringtone4.mp3
CY_RO_CY_DEFAULT_MMSTONE=BLU_Message3.mp3
CY_RO_CY_DEFAULT_MMSTONE2=BLU_Message3.mp3
CY_RO_CY_DEFAULT_VIDEOCALL=BLU_Message3.mp3
CY_ALARM_VOL_DEFAULT=5
CY3RD_MSHOP_SUPPORT=yes_install
CY3RD_AMAZONVIDEO_SUPPORT=yes_install
CY3RD_OPERA_SUPPORT=yes
CY3RD_NEXTRADIO_SUPPORT=yes
CY3RD_BLUHELP_SUPPORT=no
CY3RD_BLUAppCloud_SUPPORT=no
CY3RD_BLU_DTIGNITECLIENT_SUPPORT=yes
CY_BLU_SPE_CHIPSET=MT6771
CY_BLU_SPE_CHIPSET_INFO=2.0 GHz Quad-core
CY_BLU_SPE_SIMSLOTS=2
CY_BLU_SPE_RAM=4 Gb
CY_BLU_SPE_ROM=64 Gb
CY_BLU_SPE_2G=B2/B3/B5/B8
CY_BLU_SPE_3G=B1/B2/B4/B5/B8
CY_BLU_SPE_4G=B1/B2/B3/B4/B5/B7/B8/B12/B13/B17/B28/B66
CY_BLU_SPE_CDMA=
CY_BLU_SPE_BATTERY=Internal
CY_BLU_SPE_BATTERY_CAPACITY=3000mAh
CY_BLU_SPE_CAMERA_REAR=16MP
CY_BLU_SPE_CAMERA_REAR_DEFAULT=10MP
CY_BLU_SPE_CAMERA_FRONT=16MP
CY_BLU_SPE_CAMERA_FRONT_DEFAULT=10MP
CY_BLU_SPE_LANGUAGES=37
CY_BLU_SPE_WIFI_2_4=B/G/N
CY_BLU_SPE_WIFI_5_0=A/N/AC
CY_BLU_SPE_BLUETOOTH=BT4.2
CY_BLU_DISPLAY_SIZE=6.2
CY_BLU_RESOLUTION=1080*2246
CY_BLU_HW_LCD_INFO=TIANMA FHD 2246*1080
CY_BLU_HW_FLASH_INFO=SAMSUNG KMDH6001DM-B422 64GB+4GB/SAMSUNG KMDH6001CM-B705 128GB+6GB
CY_BLU_HW_CAM_INFO=FF OF OV16885-4C 16M*AF OF OV16885 F/2.0 16M+ FF OF Hi556 F2.2 5M
CY_BLU_PCBA_INFO=Vivo_XI+_MAINBOARD_P3
CY_RO_CY_MMI_BLUFM=yes
CY_CUSTOM_SN16_SUPPORT=yes
GN3RD_BLU_SUPPORT=yes
CY_GMSEXPRESS_PLUS_SUPPORT=yes
CY_RO_GOOGLE_DIALER_SUPPORT=yes
CY_SHUTDOWN_SUPPORT=yes
CY_RO_POWER_ON_RING_SUPPORT=yes
CY_POWER_ON_RING_SUPPORT=yes
CHENYEE_DATA_MANAGER_SUPPORT=yes
CY_RO_CY_MATCH_NUMBERLENGTH=7
CONFIG_MEDIA_VOL_DEFAULT=11
CY_EMERGENCY_CALLLOG_SUPPORT=no
CY_VIDEOQUALITY_DEFAULT=fine
CY_LANG_CLEAN_XAXB=yes
MTK_CMAS_SUPPORT=yes
CY_INCREASE_BOOTTIME=yes
MTK_VOLTE_SUPPORT=yes
MTK_DYNAMIC_SBP_SUPPORT=yes
MTK_MD_SBP_CUSTOM_VALUE=0
CONFIG_MTK_MD_SBP_CUSTOM_VALUE=0
OPTR_SPEC_SEG_DEF=NONE
...
CY_ENHANCED_4G_MODE_OFF=yes
XPERI_DTS_EFFECTS_5=yes
CY_APP_DTS_SUPPORT=yes
CY_SSGACCESSCALL_SUPPORT=no
CY_SSGDIAL_SUPPORT=no
CY_QUICK_UNLOCK_SUPPORT=yes
CY_APP_NOAUTOBOOT_SUPPORT=yes
CY_ENHANCED_FULLMODE=yes
CY_APPCLONE_SUPPORT=no
CY_APK_APPCLONE_SUPPORT=no
CY_APP_CAMERA_PLUGIN_GIFSHOT_SUPPORT=yes
CY_APP_CAMERA_PLUGIN_SCAN_SUPPORT=yes
CY3RD_BLUPRIVACY_SUPPORT=yes
CY_FACE_LOCK_LIGHT_SUPPORT=no
CY_PRIVATESPACE_ONE=no
CY_REMOVE_AOSP_SOUNDS=yes
CY_APP_SYSTEMMANAGER_SDK_SUPPORT=no
MTK_DURASPEED_SUPPORT=no
MTK_DURASPEED_DEFAULT_ON=no
CY_CAMERA_DEBUG_INFO_OFF=yes
CY_APP_DEV_BUGREPORT_SUPPORT=no
MTK_YIQI_FONTS_FRAMEWORK_SUPPORT=no
LOVELYFONTS_SUPPORT=no
CY_LOVELYFONTS_SUPPORT=no
CY_APP_BUGREPORT_SUPPORT=no
CY_RO_CY_MMI_CDMA=no
CY_RO_CY_MMI_LTETDD=no
MTK_CAM_HAL_VERSION=1
MTK_CAMERA_APP_VERSION=2
CY_NOTCH_SUPPORT=yes
CY_NOTCH_SQUARE_SUPPORT=yes
MTK_PERMISSION_CONTROL=no
MTK_MOBILE_MANAGEMENT=no
MTK_CTA_SET=no
# Chenyee <20180508> <taofp> add for cy_build cy_auto_config_end
